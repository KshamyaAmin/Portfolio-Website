...
- 🧩 Strengths: **Software development, Web engineering, Data & analytics, Clean code**  
...
- ☁️ **Weather App** — Real-time weather dashboard using APIs & JS  
- 🍳 **Smart Recipe Generator (Mini Project)** — Suggests recipes based on available ingredients  
